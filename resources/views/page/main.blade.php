...
<div class="row">
    <div class="col-md-12">
        <div class="jumbotron jumbotron-fluid ">
           <div class="container">
             <h1 class="display-4 text-center font-weight-bolder hh1 ">Dark Blog</h1>
             <p class="lead text-sm-center font-weight-lighter hh1">normal people have no idea how beautiful the darkness is</p>
          </div>
       </div>
   </div>
</div> <!-- endHead row div -->
